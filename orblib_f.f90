...
contains
  ...
  !----------------------------------------------------------------------
    ...
    quad_nr  = 9   !10 !15 ! int(NEner / integrator_dithering*0.55 )  
    quad_nth = 4    !4  !4 ! int(nI2   / integrator_dithering ) - 1 ! towards middle axis
    quad_nph = 5    ! 5 !5 ! int(nI3   / integrator_dithering ) - 1 ! towards minor axis
