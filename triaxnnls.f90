...
real(kind=dp),dimension(:),allocatable,private ::con,econ,enermass
...
do i=1,orbitsinfit
   write (unit=30, fmt="(6i8,es13.5)") i, orbint(1:4,i),orbtype(i),orbweight(i)
end do
...
subroutine makekinem(select)
  ...
  integer (kind=i4b) :: i,j,k,l,m,orb_qualify
